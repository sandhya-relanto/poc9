...
const NAV_ITEMS = [
  ...
  { name: 'Scenario Library', href: '/scenarios' },
  { name: 'Coaching Center', href: '/coaching' },
      ...
      <div className="p-8 border-t border-[#D8CCBC]/50">
        {!collapsed ? (
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-[#EFE7DC]/50 border border-[#D8CCBC]/30">
            <div className="w-10 h-10 bg-[#D6C2A8] rounded-xl flex items-center justify-center text-xs font-black text-[#3A2F28] shadow-sm">M</div>
            <div className="flex-1 overflow-hidden">
              <p className="text-xs font-black text-[#3A2F28] truncate uppercase tracking-widest">Manager Suite</p>
              <p className="text-[9px] text-[#7B6F63] font-bold uppercase tracking-[0.2em] mt-1">Enterprise</p>
            </div>
          </div>
        ) : (
          <div className="w-10 h-10 bg-[#EFE7DC] border border-[#D8CCBC] rounded-xl flex items-center justify-center text-xs font-black text-[#3A2F28] mx-auto">M</div>
        )}
      </div>
    </aside>
  )
